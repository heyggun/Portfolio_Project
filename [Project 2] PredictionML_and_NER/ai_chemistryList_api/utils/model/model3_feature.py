...
class Model3 :
    ...
    def height_weight_transform(self, df):
        df['mate_height'] = df['mate_height'].astype(int)
        df['ptr_mate_height'] = df['ptr_mate_height'].astype(int)
        df['mate_weight'] = df['mate_weight'].astype(int)
        df['ptr_mate_weight'] = df['ptr_mate_weight'].astype(int)
